...
export OUTPUT_DIR="${OUTPUT_DIR:-runs/sd35-mv-sbs-fft-vindr-better-40k-emd-1e-1-cosine}"
export WANDB_NAME="${WANDB_NAME:-sd35-mv-sbs-fft-vindr-better-40k-emd-1e-1-cosine}"
